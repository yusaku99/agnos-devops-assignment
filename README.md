...
* **Worker Service**: A background processor responsible for updating record timestamps.

Both services are containerized using **Multi-stage Docker builds** and deployed on **Kubernetes** with high availability (HA).
